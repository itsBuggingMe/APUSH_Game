...
namespace APUSH_Game.GameState
{
    internal class StateManager
    {
        ...
        public void RegionSelected(RegionObject region) => states[(int)world.SelectedAction].Select(region);
        public void RegionDeselected(RegionObject region) => states[(int)world.SelectedAction].Deselect(region);
        public bool AllowSelect(RegionObject region) => states[(int)world.SelectedAction].AllowSelect(region);
        ...
        private abstract class State
        {
            ...
            internal virtual void Select(RegionObject selected) { }
            internal virtual void Deselect(RegionObject deselected) { }
            internal virtual void Init() { }
            internal virtual bool AllowSelect(RegionObject selected) => true;
        }
        #endregion
        ...
        private class MoveTroopState : State
        {
            ...
            internal override void Select(RegionObject selected)
            {
                ...
                else if (CanMoveTo(Parent.Primary, selected))
                {
                    ...
                    World.GameObjects.Add(new ScrollSelector("                        ", s =>
                    {
            ...
            internal override bool AllowSelect(RegionObject selected) => (selected.Data.TerritoryType != TerrioryType.ConfederateState) == World.Current && selected.CurrentTroops.TroopCount != 0;
        }
